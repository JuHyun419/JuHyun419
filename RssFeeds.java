...
public class RssFeeds {
    ...
    public static final String URL = "https://zzang9ha.tistory.com/rss";
    public static final int MAX_POST = 5;
    ...
    public static void main(String[] args) throws IOException, FeedException {
        ...
        SyndFeed feed = syndFeedInput.build(new XmlReader(new URL(URL)));
        ...
        String readmeText = README + blogPosts.toString();
